function ensureMuseumSection() {
  ...
  const imgs = [
    ...
    },
    {
      ...
      t: 'Η κεντρική αίθουσα' ,
      c: 'Ένα ταξίδι στο παρελθόν'
    },
    {
      src: 'assets/photos/FB_IMG_1782483436926.jpg',
      fallback: ['photos/FB_IMG_1782483436926.jpg', 'assets/photos/museum-laografiko.jpg'],
      t: 'Όπλα και αντικείμενα μιας άλλης εποχής',
      c: 'Εκθέματα από τα τέλη του 19ου αιώνα'
    },
    {
    ...
    },
    {
      ...
      t: 'Οικιακά αντικείμενα',
      c: 'Σκεύη και αντικείμενα σπιτιού συγκροτούν μια καθαρή εικόνα της παλιάς ζωής στο Πωγώνι.'
    }
  ];
